        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">Edulevel</h3><!-- /.menu-title -->
                    ...
                    <li class="menu-item-has-children active dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>My Bimble</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="{{url('home')}}">Home</a></li>
                            <li><i class="fa fa-table"></i><a href="{{url('edulevels')}}">Edu level</a></li>
                            <li><i class="fa fa-table"></i><a href="{{url('programs')}}">Program</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
